QuestHelper_File["utility.lua"] = "1.4.1"
...
function QuestHelper:ZoneSanity()
  -- Skip zone sanity check for WOTLK 3.3.5 to prevent false "out of date" warnings
  local buildInfo = GetBuildInfo()
  if buildInfo and buildInfo:match("^3%.3%.5") then
    return true  -- Always return true for WOTLK 3.3.5
  end
